//klimanova 2016-09-20
//создание согласования c руководителем, если он не заказчик Заявки
// скрипт копирования атрибутов системный объект - пользовательский объект



if ((subject.headName != null)&&(subject?.clientEmployee!=subject?.headName)){
...
def attrs = [:];
attrs[CAB]= subject.headName;
attrs[SERVICE_CALL]= subject;
attrs[AUTHOR]=subject.clientEmployee
PH=subject.localPhone?'да':'нет'
MPH=subject.mobilePhone?'да':'нет'
def TEXT='<strong>'+'Просьба согласовать заявку на нового сотрудника: '+'</strong>'+'</br>'+'<span style="color: #848484;">'+'ФИО нового сотрудника: '+'</span>'+subject?.newEmplName+'</br>'+'<span style="color: #848484;">'+'Организация (ЮЛ): '+'</span>'+subject?.legalEntity?.title+'</br>'+'<span style="color: #848484;">'+'Фамилия и имя в латинской транскрипции: '+'</span>'+subject?.transliteName+'</br>'+'<span style="color: #848484;">'+'Департамент/отдел: '+'</span>'+subject?.OU?.title+'</br>'+'<span style="color: #848484;">'+'Должность: '+'</span>'+subject?.position+'</br>'+'<span style="color: #848484;">'+'ФИО руководителя: '+'</span>'+subject?.headName?.title+'</br>'+'<span style="color: #848484;">'+'Стационарный телефон: '+'</span>'+PH+'</br>'+'<span style="color: #848484;">'+'Расположение, адреc: '+'</span>'+subject?.restaurant?.title+'</br>'+'<span style="color: #848484;">'+'Почтовые группы: '+'</span>'+subject?.mailGroups?.title+'</br>'+'<span style="color: #848484;">'+'Сетевые ресурсы: '+'</span>'+subject?.networkResours+'</br>'+'<span style="color: #848484;">'+'Базы 1С: '+'</span>'+subject?.base1C?.title+'</br>'+'<span style="color: #848484;">'+'ПО установленное: '+'</span>'+subject?.installedSoft+'</br>'+'<span style="color: #848484;">'+'Ресурсы интернет: '+'</span>'+subject?.internet?.title
  attrs[DESCRIPT]= TEXT
...
def attrs = [:];
attrs[CAB]= utils.get('employee$16523202')
attrs[SERVICE_CALL]= subject;
