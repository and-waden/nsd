...
def dateStart = '00:00:00 01.09.2019'
def dateStop = '23:59:59 30.09.2019'
def team = utils.get('team$158703703')//А8
//def team = utils.get('team$122800201')//ККС 
//def team = utils.get('team$144083901')//ХэлпЛайн

def report = getReport(dateStart, dateStop, team)

api.mail.sender.send(['u@shoko.ru':null, 'u@shoko.ru':null, 'u@shoko.ru':null], 'Отчет по заявкам за сентябрь командой ' + team?.title, report, "text/html")